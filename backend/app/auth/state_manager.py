...
class OAuthStateManager:
    ...
    def create_state(self, add_new_account: bool = False) -> str:
        ...
        signature = hmac.new(self._secret, message, hashlib.sha256).hexdigest()[:16]
    ...
    def _cleanup_expired_unsafe(self) -> None:
        ...
        now = time.time()
        expired = [
            s for s, data in self._pending_states.items()
